...
const WrapperNMCMorning = (props: Props) => {
    ...
    try {
      ...
      if (reportOutPut.data.hits.hits.length === 0) {
        ...
        payload.forEach((element: any) => {
          Total = Total + element.Morning.Total;
          Clean = Clean + element.Morning.Clean;
          Damaged = Damaged + element.Morning.Damaged;
          Blocked = Blocked + element.Morning.Blocked;
          Locked = Locked + element.Morning.Locked;
          skipped = skipped + element.Morning.skipped;
        });
        setNone(false);
        setValue([
          {
            ...
            <Button
              ...
              onClick={() => {
                if (download.length === 0) {
                  ...
                  const data = download;
                  const fileName = `tmsreport_morning_${
                    getJtypeandJname()[0]
...
export default WrapperNMCMorning;
